...
<template>
  <div class="modal-window" @click.self="toogleWindowStatus('deleteTest')">
    <div class="wrapper">
      <header class="header">
        <p class="header-title">Удаление теста</p>
        <button class="close" @click.stop="toogleWindowStatus('deleteTest')">
      ...
      <main class="main">
        ...
        <p class="description">5 вопросов</p>
      </main>
      <footer class="footer">
